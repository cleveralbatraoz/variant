...
template <typename Variant>
struct variant_size<Variant volatile> : variant_size<Variant>
{
};

template <typename Variant>
struct variant_size<Variant const volatile> : variant_size<Variant>
{
};
...
template <size_t Index, typename... Types>
struct variant_alternative<Index, variant<Types...> const>
{
    using type = std::add_const_t<details::type_alternative_t<Index, Types...>>;
};

template <size_t Index, typename... Types>
struct variant_alternative<Index, variant<Types...> volatile>
{
    using type = std::add_volatile_t<details::type_alternative_t<Index, Types...>>;
};

template <size_t Index, typename... Types>
struct variant_alternative<Index, variant<Types...> const volatile>
{
...
constexpr Required& get(variant<Types...>& v)
{
...
template <typename Required, typename... Types>
constexpr Required const& get(variant<Types...> const& v)
{
    constexpr size_t Index = details::type_index_v<Required, Types...>;
    return get<Index>(v);
}
...
template <size_t Index, typename... Types>
constexpr std::add_pointer_t<details::type_alternative_t<Index, Types...>>
...
constexpr std::add_pointer_t<Type> get_if(variant<Types...>* pv) noexcept
{
